            ...
            <main className="pt-32 pb-24 max-w-4xl mx-auto px-6 font-sans">
                ...
                <div className="prose prose-slate max-w-none text-xs sm:text-sm leading-relaxed space-y-6 text-slate-600">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>Contact points including electronic mail addresses and domestic telephone networks.</li>
                        <li>Transactional tokens and card logs processed safely via encrypted third-party vendor checkouts.</li>
                    </ul>

                    <h3 className="font-mono text-xs font-bold text-slate-900 uppercase tracking-wider pt-4">3. Data Sharing Restrictions</h3>
                    <p>
                        Lumen Phi does not trade, distribute, lease, or reveal consumer identifying details to marketing agencies. Information is shared exclusively to comply with Indian telecommunication parameters or to resolve automated clearing house validation checks initiated by our institutional merchant processors.
                    </p>

                    <h3 className="font-mono text-xs font-bold text-slate-900 uppercase tracking-wider pt-4">4. Client Security Controls</h3>
                    <p>
                        Subscribers maintain full authority to adjust profile data, request complete file deletion, or terminate lightwave equipment configurations at any time by contacting our centralized dispatch core at <code>operations@lumenphi.com</code>.
                    </p>
                </div>
            </main>
