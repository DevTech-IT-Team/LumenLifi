        ...
        <div className="min-h-screen bg-white text-slate-800 antialiased selection:bg-emerald-100">
            ...
            <main className="pt-32 pb-24 max-w-4xl mx-auto px-6 font-sans">
                ...
                <div className="prose prose-slate max-w-none text-xs sm:text-sm leading-relaxed space-y-6 text-slate-600">
                    <p>
                        Welcome to <strong>Lumen Phi</strong>. These terms manage the usage, deployment constraints, and installation provisioning of our residential lightwave network hardware systems in India. By initiating a subscription layer or checking out, you accept these terms completely.
                    </p>
                    ...
                    <div className="p-4 bg-slate-50 border border-slate-200/60 rounded-xl space-y-2">
                        ...
                        <p className="text-xs text-slate-500">
                            Subscribers understand that Lumen Phi provides home internet connectivity powered by high-frequency visible light waves instead of radio wave emissions. Hardware packages (Core Router, Ceiling Antennas, and USB Dongles) must be deployed in accordance with local safety metrics.
                        </p>
                    </div>
                    ...
                    <p>
                        Residential plans are processed on an automated rolling schedule. All prices listed reflect domestic Indian valuations. Accounts must provide active, verifiable funding channels to pass automated financial validations required by our merchant processors.
                    </p>

                    <h3 className="font-mono text-xs font-bold text-slate-900 uppercase tracking-wider pt-4">3. Device Allocation & Maintenance</h3>
                    <p>
                        Any optical transceiver arrays, ceiling luminaire antennas, or adapter dongles shipped to your coordinates remain systemic hardware investments of Lumen Phi unless bought out explicitly. Users agree not to modify internal diode arrays or break protective casings.
                    </p>

                    <h3 className="font-mono text-xs font-bold text-slate-900 uppercase tracking-wider pt-4">4. Liability Safeguards</h3>
                    <p>
                        Lumen Phi is not responsible for temporary transmission drops caused by physical obstructions blocking structural overhead line-of-sight tracking arrays. Optical pathways are contained strictly by solid walls, protecting adjacent residential environments.
                    </p>

                    <h3 className="font-mono text-xs font-bold text-slate-900 uppercase tracking-wider pt-4">5. Technical Resolution</h3>
                    <p>
                        For compliance queries, billing updates, or general network setup cancellations, reach out directly to our processing office at <code>operations@lumenphi.com</code>.
                    </p>
                </div>
            </main>
